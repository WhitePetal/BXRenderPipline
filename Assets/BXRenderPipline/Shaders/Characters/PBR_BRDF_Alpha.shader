Shader "BXCharacters/PBR_BRDF_Alpha"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            Tags {"LightMode"="BXCharacterAlphaDepth"}
            ZWrite On
            ColorMask 0
            HLSLPROGRAM
            #pragma target 3.5
            ...
            v2f vert (appdata v)
            {
                ...
                o.vertex = TransformWorldToHClip(pos_world.xyz);
        ...
        Pass
        {
            Tags {"LightMode"="BXCharacterAlpha"}
            ZWrite Off
            ZTest Equal
            ...
            FragOutput frag (v2f i)
            {
                ...
                output.lightingBuffer = half4(lighting, baseColor.a);
